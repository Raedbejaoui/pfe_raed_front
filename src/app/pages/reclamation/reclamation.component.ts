...
export class ReclamationComponent implements OnInit{
  ...
  @ViewChild('reclamationDialog') reclamationDialog!: TemplateRef<any>;
  @ViewChild('addReclamationDialog') addReclamationDialog!: TemplateRef<any>;
  @ViewChild('updateEtatDialog') updateEtatDialog!: TemplateRef<any>;
  @ViewChild('updateReclamationDialog') updateReclamationDialog!: TemplateRef<any>;
